"""
amqp_publisher.py
Shared utility for publishing messages to the ctms_topic exchange.
Used by: queue, purchase_window, resale_purchase, concert_cancellation
"""
import json
import os
import pika
...
def publish(routing_key: str, payload: dict) -> None:
    """
    Publish a JSON message to ctms_topic with the given routing_key.

    Args:
        routing_key: e.g. "ticket.purchased", "concert.cancelled"
